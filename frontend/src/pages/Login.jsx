  ...
  const loginMutation = useMutation({
    ...
    onError: (error) => {
      ...
      if (detail.includes('verify your email')) {
        ...
        setErrors({ general: 'Account locked due to failed login attempts. Try again later.' })
      ...
      <div className="max-w-md w-full">
        ...
        {message === 'verified' && (
          <div className="mb-6 p-4 bg-success-50 border border-success-200 rounded-lg">
            <p className="text-sm text-success-800">✅ Email verified successfully! Please sign in.</p>
          </div>
        )}
        
        {message === 'password_reset' && (
          <div className="mb-6 p-4 bg-success-50 border border-success-200 rounded-lg">
            <p className="text-sm text-success-800">✅ Password reset successfully! Please sign in.</p>
          </div>
        )}
        ...
        {oauthError && (
          <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-red-800 font-medium">OAuth Login Failed</p>
              <p className="text-sm text-red-700 mt-1">
                {oauthError === 'oauth_failed' ? 'Could not complete OAuth login. Please try again.' : oauthError}
              </p>
            </div>
          </div>
        )}
        ...
        <div className="card">
          ...
          <div className="space-y-3 mb-6">
            <button onClick={handleGoogleLogin} className="btn btn-secondary w-full flex items-center justify-center gap-3" type="button">
            ...
            <button onClick={handleGitHubLogin} className="btn btn-secondary w-full flex items-center justify-center gap-3" type="button">
